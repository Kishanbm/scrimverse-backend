...
3. Set up AWS S3 for media storage (`USE_S3=True`)
4. Configure AWS SES for email
5. Set strong `SECRET_KEY` and `JWT_SECRET_KEY`
...
10. Set up Celery with supervisor or systemd
11. Use Gunicorn/uWSGI for WSGI server
