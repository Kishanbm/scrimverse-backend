...
from .views import (
    ...
    TournamentUpdateView, TournamentDeleteView, HostTournamentsView,
    
    # Scrim URLs
    ScrimListView, ScrimDetailView, ScrimCreateView,
    ScrimUpdateView, ScrimDeleteView,
    
    # Registration URLs
    TournamentRegistrationCreateView, ScrimRegistrationCreateView,
    PlayerTournamentRegistrationsView, PlayerScrimRegistrationsView,
    
    # Rating URLs
    HostRatingCreateView, HostRatingsListView
)
