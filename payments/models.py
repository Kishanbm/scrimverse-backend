...
class Payment(models.Model):
    ...
    phonepe_order_id = models.CharField(
        max_length=100, blank=True, null=True, help_text="Order ID generated by PhonePe"
    )
    phonepe_transaction_id = models.CharField(
        max_length=100, blank=True, null=True, help_text="Transaction ID from PhonePe"
    )
    ...
    payment_mode = models.CharField(max_length=50, blank=True, null=True, help_text="UPI, Card, NetBanking, etc.")
    instrument_type = models.CharField(
        max_length=50, blank=True, null=True, help_text="ACCOUNT, CREDIT_CARD, DEBIT_CARD, etc."
    )

    # PhonePe Response Data
    redirect_url = models.TextField(blank=True, null=True, help_text="PhonePe checkout URL")
    callback_data = models.JSONField(
        default=dict, blank=True, null=True, help_text="Complete callback response from PhonePe"
    )
...
class Refund(models.Model):
    ...
    phonepe_refund_id = models.CharField(
        max_length=255, blank=True, null=True, help_text="Refund ID generated by PhonePe"
    )
